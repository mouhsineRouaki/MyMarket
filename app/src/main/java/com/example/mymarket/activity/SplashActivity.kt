...
class SplashActivity: AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        VilleService.create(ville(villeType.CasaBlanca, 20000_000))
        VilleService.create(ville(villeType.Agadir, 6000_000))
        VilleService.create(ville(villeType.Tanger, 1000_000))
        VilleService.create(ville(villeType.Marrakech, 1500_000))
        VilleService.create(ville(villeType.Rabat, 2000_000))
        VilleService.create(ville(villeType.Fes, 9700_000))
        VilleService.create(ville(villeType.Meknes, 9300_000))
        VilleService.create(ville(villeType.Oujda, 800_000))
        VilleService.create(ville(villeType.Nador, 7000_000))
        VilleService.create(ville(villeType.Tetouan, 9000_000))
        VilleService.create(ville(villeType.Kenitra, 9500_000))
        VilleService.create(ville(villeType.Laayoune, 5000_000))
        VilleService.create(ville(villeType.Essaouira, 4000_000))
        VilleService.create(ville(villeType.ElJadida, 5500_000))
        VilleService.create(ville(villeType.Mohammedia, 8500_000))
        VilleService.create(ville(villeType.Settat, 4500_000))
        VilleService.create(ville(villeType.Taza, 3500_000))
        VilleService.create(ville(villeType.Khouribga, 3000_000))
        VilleService.create(ville(villeType.BeniMellal, 6000_000))
        VilleService.create(ville(villeType.Guelmim, 2500_000))
        VilleService.create(ville(villeType.Dakhla, 2000_000))
        VilleService.create(ville(villeType.Zagora, 1500_000))
        VilleService.create(ville(villeType.KsarElKebir, 2200_000))
