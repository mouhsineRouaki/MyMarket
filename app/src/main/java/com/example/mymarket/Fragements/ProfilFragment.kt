...
class ProfilFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnFrancais.setOnClickListener {
            ...
            ProduitService.create(Produit(R.drawable.khmiss,"Masque Ghassoul", "Masque naturel au ghassoul marocain", 70.0, "Embellissement", 60));ProduitService.create(Produit(R.drawable.oranges,"Oranges", "Oranges juteuses et sucrées, idéales pour un jus frais.", 4.9, "Fruits", 60))
